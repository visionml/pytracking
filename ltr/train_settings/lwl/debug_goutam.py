...
def run(settings):
    ...
    # Datasets
    ytvos_train =  Davis(version='2017', multiobj=False, split='train')
    davis_train = Davis(version='2017', multiobj=False, split='train')

    ytvos_val =  Davis(version='2017', multiobj=False, split='train')
    ...
    trainer.train(70, load_latest=True, fail_safe=False)
