...
class Tracking():
    ...
    def __init__(self):
        ...
        # RTSP Stream
        self.rtsp = 'rtsp://admin:admin1234@192.168.1.196:554/cam/realmonitor?channel=1&subtype=0'
        #self.rtsp = "rtsp://192.168.1.176:8554/unicast"
        #self.rtsp = 0
        ...
        self.serverAddressPort = ("192.168.1.176", 8554)
