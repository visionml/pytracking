...
**Note:**  
- PyTorch 1.0 should be supported, but **not recommended** as it requires an alternate compilation of the PreciseRoIPooling module which hasn't been tested. [See](https://github.com/vacancy/PreciseRoIPooling).  
